...
const outputPath = path.join(projectDir, "artifacts/videos/atmos-intro-editorial-16x9-1080p.mp4");
const posterPath = path.join(projectDir, "artifacts/images/atmos-intro-editorial-16x9-1080p-poster.jpg");
const musicPath = path.join(projectDir, "artifacts/audio/atmos-intro-editorial-soundtrack.wav");
const consumerTargets = [
  {
    name: "landing public",
    video: path.join(repoRoot, "apps/landing/public/videos/atmos-intro-editorial.mp4"),
    poster: path.join(repoRoot, "apps/landing/public/videos/atmos-intro-editorial-poster.jpg"),
  },
];
...
const posterFrame = Math.max(1, Math.min(totalFrames, Math.round(fps * 9.6)));
