  ...
  - generic [ref=f2e7]:
    - banner [ref=f2e8]:
      ...
      - generic [ref=f2e34]:
        - generic [ref=f2e35]:
          ...
          - button "atmos/e2e/app043-warm-b-mt321tj4" [ref=f2e41] [cursor=pointer]
    ...
    - generic [ref=f2e68]:
      - complementary [ref=f2e71]:
        ...
        - generic [ref=f2e158]:
          - generic [ref=f2e159]:
            - button "A Atmos E2E" [ref=f2e160] [cursor=pointer]:
              - generic [ref=f2e161]:
                - generic [ref=f2e162]: A
                - generic [ref=f2e164]: Atmos E2E
            - generic:
              - generic:
                - button
                - button
          - generic [ref=f2e168]:
            - button "APP-043 Warm B mt321tj4" [ref=f2e170] [cursor=pointer]
            - button "nidorino" [ref=f2e180] [cursor=pointer]
        - generic [ref=f2e190]:
        ...
        - main [ref=f2e211]:
          - generic [ref=f2e212]:
            - tablist [ref=f2e215]:
              - tab [ref=f2e216]
              - button [ref=f2e222]:
                - tab "Close atmos-e2e/e2e-app043-warm-b-mt321tj4 atmos-e2e/e2e-app043-warm-b-mt321tj4" [selected] [ref=f2e223]:
                  - generic [ref=f2e225]:
                    - button "Close atmos-e2e/e2e-app043-warm-b-mt321tj4"
                  - generic [ref=f2e230]: atmos-e2e/e2e-app043-warm-b-mt321tj4
              - generic [ref=f2e231]:
                - button "New tab" [ref=f2e232]
                - button "Open tab groups" [ref=f2e234]
            - generic [ref=f2e244]:
              - generic [ref=f2e245]:
                - generic "atmos-e2e/e2e-app043-warm-b-mt321tj4" [ref=f2e247]
                - generic [ref=f2e253]:
                  - generic:
                    ...
                    - generic:
                      ...
                      - generic:
                        ...
                        - button "Close (⌘W)"
              - generic [ref=f2e254]:
                - textbox "Terminal input" [active] [ref=f2e260]
                - generic [ref=f2e263]:
                  - generic [ref=f2e265]:
                    - generic [ref=f2e266]: "[⌘ + (⇧ Pin) + G] Input anything to terminal (@ annotation, / command, or paste img)"
                    - button "Send to terminal" [disabled] [ref=f2e269]
                  - button "Open agent input" [ref=f2e273]
        - contentinfo [ref=f2e274]:
          - button "Local 0" [ref=f2e276]
          - button "Napping ~" [ref=f2e282] [cursor=pointer]:
            - generic [ref=f2e283]:
              - generic [ref=f2e284]:
                - generic [ref=f2e288]: z
                - generic [ref=f2e289]: z
                - generic [ref=f2e290]: z
              - generic [ref=f2e291]: Napping ~
  - alert [ref=f2e292]
  - generic:
