    ...
    - banner [ref=f2e9]:
      ...
      - generic [ref=f2e34]:
        - generic [ref=f2e35]:
          ...
          - button "atmos/kakuna" [ref=f2e41] [cursor=pointer]
        ...
        - generic [ref=f2e158]:
          - generic [ref=f2e159]:
            - button "Atmos E2E ⠇" [ref=f2e160] [cursor=pointer]:
              - generic [ref=f2e161]:
                - generic: Atmos E2E
                - generic "Agent running" [ref=f2e164]: ⠇
            - generic:
              - generic:
                - button
                - button
          - generic [ref=f2e170]:
            - button "APP-043 Warm B mterje8o" [ref=f2e172] [cursor=pointer]
            - button "kakuna" [ref=f2e182] [cursor=pointer]
        - generic [ref=f2e192]:
          - button "Add Project" [ref=f2e194]
          - generic [ref=f2e198]:
            - button [ref=f2e199]
            - button "Open settings" [ref=f2e202]
      ...
      - generic [ref=f2e210]:
        - main [ref=f2e213]:
          - generic [ref=f2e214]:
            - tablist [ref=f2e223]:
              - button [ref=f2e225]:
                - tab "Close atmos-e2e/kakuna atmos-e2e/kakuna" [selected] [ref=f2e226]:
                  - generic [ref=f2e227]:
                    - button "Close atmos-e2e/kakuna"
                  - generic [ref=f2e232]: atmos-e2e/kakuna
              - generic [ref=f2e234]:
                - button "New tab" [ref=f2e235]
                - button "Open tab groups" [ref=f2e237]
            - generic [ref=f2e246]:
              - generic [ref=f2e247]:
                - generic "atmos-e2e/kakuna" [ref=f2e249]
                - generic [ref=f2e255]:
                  - generic:
                    ...
                    - generic:
                      ...
                      - generic:
                        ...
                        - button "Close (⌘W)"
              - generic [ref=f2e256]:
                - textbox "Terminal input" [active] [ref=f2e262]
                - generic [ref=f2e265]:
                  - generic [ref=f2e267]:
                    - generic [ref=f2e268]: "[⌘ + (⇧ Pin) + G] Input anything to terminal (@ annotation, / command, or paste img)"
                    - button "Send to terminal" [disabled] [ref=f2e271]
                  - button "Open agent input" [ref=f2e275]
        - contentinfo [ref=f2e276]:
          - generic [ref=f2e277]:
            - 'button "Resource Monitor: CPU 90% · Memory 16%" [ref=f2e278]':
              - generic [ref=f2e281]: Monitor
            - button "Local 0" [ref=f2e284]
          - button [ref=f2e290] [cursor=pointer]:
            - generic "1 Running" [ref=f2e292]:
              - generic "Agent running" [ref=f2e295]: ⠼
