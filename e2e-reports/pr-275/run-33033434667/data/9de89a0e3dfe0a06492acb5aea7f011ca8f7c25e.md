    ...
    - banner [ref=f2e9]:
      - generic [ref=f2e10]:
        ...
        - generic [ref=f2e28]:
          ...
          - button [ref=f2e31]
        - 'button "Workspace status: Review Setup Script" [ref=f2e36] [cursor=pointer]':
          - generic [ref=f2e37]: "50"
          - generic [ref=f2e42]: Review Setup Script
      - generic [ref=f2e44]:
        - generic [ref=f2e45]:
          - status "Unable to compare the remote branch with origin/main" [ref=f2e46]
          - button "atmos/pikachu" [ref=f2e51] [cursor=pointer]
        - button "origin/ main" [ref=f2e58] [cursor=pointer]:
          - generic [ref=f2e59]: origin/
          - generic [ref=f2e60]: main
      - generic [ref=f2e63]:
        - button "Search" [ref=f2e64] [cursor=pointer]:
          - generic [ref=f2e68]: Search...
          - generic: K
        - button "Open workspace summary" [ref=f2e69]
        - button "Usage" [ref=f2e73]
    - generic [ref=f2e78]:
      - complementary [ref=f2e81]:
        - generic [ref=f2e82]:
          - generic [ref=f2e83]:
            - button "Launchpad" [ref=f2e84] [cursor=pointer]
            - generic [ref=f2e93]:
              - button "Workspaces" [ref=f2e95]
              - button "Disk Analyzer" [ref=f2e101]
          - navigation "Launchpad" [ref=f2e106]:
            - button "Skills" [ref=f2e108]
            - button "Automations" [ref=f2e114]
            - button "Token Usage" [ref=f2e121]
            - button "Agent Observer" [ref=f2e129]
            - button "Canvas" [ref=f2e134]
            - button "Prototype Design" [ref=f2e144]
            - button "Task" [ref=f2e157]
            - button "New Workspace" [ref=f2e164]
        - generic [ref=f2e171]:
          - generic [ref=f2e173]:
            - generic [ref=f2e174]:
              - button "Atmos E2E" [ref=f2e175] [cursor=pointer]
              - generic:
                - generic:
                  - button
                  - button
      ...
      - generic [ref=f2e243]:
        - main [ref=f2e246]:
          - generic [ref=f2e247]:
            - tablist [ref=f2e256]:
              - button [ref=f2e257]:
                - tab "Close atmos-e2e/pikachu atmos-e2e/pikachu" [selected] [ref=f2e258]:
                  - generic [ref=f2e259]:
                    - button "Close atmos-e2e/pikachu"
                  - generic [ref=f2e264]: atmos-e2e/pikachu
              - generic [ref=f2e265]:
                - button "New tab" [ref=f2e266]
                - button "Open tab groups" [ref=f2e268]
            - generic [ref=f2e277]:
              - generic [ref=f2e278]:
                - generic "atmos-e2e/pikachu" [ref=f2e280]
                - generic [ref=f2e286]:
                  - generic:
        ...
        - contentinfo [ref=f2e307]:
          - generic [ref=f2e308]:
            - 'button "Resource Monitor: CPU 69% · Memory 18%" [ref=f2e309]':
