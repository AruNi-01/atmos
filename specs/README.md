...
| **APP-062** | Terminal tmux pipe-pane live path (keep tmux; pipe-only live I/O; no control-mode fallback) | `specs/APP/APP-062_terminal-tmux-pipe-live-path/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`) |
