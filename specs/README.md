...
| **APP-058** | Workspace Simulator (iOS Simulator streamed into the workspace; SimulatorBridge in Electron main; `atmos simulator` agent CLI) | `specs/APP/APP-058_workspace-simulator/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`) |
