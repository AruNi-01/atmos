...
| **APP-060** | Workspace Simulator (iOS Simulator streamed into the workspace; SimulatorBridge in Electron main; `atmos simulator` agent CLI) | `specs/APP/APP-060_workspace-simulator/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`) |
