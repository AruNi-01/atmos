...
| **APP-058** | Workspace Device Preview (iOS Simulator in the workspace; DeviceBridge in Electron main; `atmos device` agent CLI) | `specs/APP/APP-058_workspace-device-preview/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`) |
