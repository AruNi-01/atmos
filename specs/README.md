...
| **APP-058** | Agent Status Workspace Grouping (sidebar + Task kanban By Agent) | `specs/APP/APP-058_agent-status-workspace-grouping/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`) |
