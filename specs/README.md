...
| **APP-078** | Session inbox: phone tabs plus Web/Desktop left-sidebar View (Workspace default, Session list) | `specs/APP/APP-078_mobile-session-inbox/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`) |
