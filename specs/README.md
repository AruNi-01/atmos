...
| **APP-062** | PT Design — full product: package (MCP + Ink CLI/Skill) + Atmos left sidebar → center stage. **Successor model: APP-073.** | `specs/APP/APP-062_pt-design/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`) |
...
| **APP-073** | PT Design Interactive Canvas (v2: PTX SoT, real DOM, Edit/Interact; successor to APP-062 wireframe model) | `specs/APP/APP-073_pt-design-interactive-canvas/` (`BRAINSTORM.md`, `PRD.md`, `TECH.md`, `TEST.md`; source in `source/`) |
