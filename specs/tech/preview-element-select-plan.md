...
- `v1`：在 [Preview.tsx](/Users/lurunrun/own_space/OpenSource/atmos/apps/web/src/components/run-preview/Preview.tsx) 支持同源/本地预览页的 DOM 元素选择，复用现有 `SelectionPopover`
...
## Architecture
### 1. 宿主层：Preview Host
在 [Preview.tsx](/Users/lurunrun/own_space/OpenSource/atmos/apps/web/src/components/run-preview/Preview.tsx) 新增宿主能力：
- 管理“元素选择模式”开关
- 检测 iframe 是否同源可注入
...
### 扩展 SelectionInfo
更新 [format-selection-for-ai.ts](/Users/lurunrun/own_space/OpenSource/atmos/apps/web/src/lib/format-selection-for-ai.ts)：
- 新增 preview 相关字段：
...
### 扩展 SelectionPopover
更新 [SelectionPopover.tsx](/Users/lurunrun/own_space/OpenSource/atmos/apps/web/src/components/selection/SelectionPopover.tsx)：
- `SelectionType` 增加 `"preview"`
- attach 能力改成只要传了 `onAttach` 就可用，不再绑死 wiki
- `type="preview"` 时调用新的 `formatPreviewSelectionForAI`

### PreviewProps 调整
更新 [RunPreviewPanel.tsx](/Users/lurunrun/own_space/OpenSource/atmos/apps/web/src/components/run-preview/RunPreviewPanel.tsx) 和 [Preview.tsx](/Users/lurunrun/own_space/OpenSource/atmos/apps/web/src/components/run-preview/Preview.tsx)：
- `Preview` 增加 `workspaceId`、`projectId`
- 用于把选中元素上下文写入默认 Agent composer

## Implementation Changes
### 1. Preview 宿主改造
在 [Preview.tsx](/Users/lurunrun/own_space/OpenSource/atmos/apps/web/src/components/run-preview/Preview.tsx) 中：
