# TECH · APP-063: Agent-First Product CLI

> Technical Design · HOW. Implements PRD APP-063. Addresses **M1–M22**. Nice-to-haves N1–N6 noted where relevant. **No backward compatibility** with prior CLI JSON or dual human/`--json` product output.
...
- Not a replacement for APP-063 TECH (no server/RPC internals for agents).
