# TEST · APP-058: Agent-First Product CLI

> Test Plan · verify agent-first product CLI envelope, server RPC, L1 resource commands, and `atmos-cli` agent skill packaging. References PRD APP-058 and TECH APP-058.
