# TEST · APP-019: GitHub Automation Triggers

> Test Plan · how we verify GitHub events can trigger local Atmos Automations through Relay. References PRD APP-019 and TECH APP-019.
...
- **Then**: Relay treats Token B as a different tenant, and APP-019 does not transfer installations or routes from Token A.
