# Brainstorm · APP-019: GitHub Automation Triggers
...
- **GitHub-specific identity vs Relay tenant identity**: Reuse the same stable Relay tenant identity that owns registered Computers. APP-020 owns Access Token rotation; APP-019 must not introduce a GitHub-specific Atmos identity.
