# Brainstorm · APP-020: Relay Stable Tenant Identity
...
- **GitHub routes in APP-019 vs foundation in APP-020**: APP-020 owns identity and rotation; APP-019 depends on it.
...
- Promote to TEST: Cover migration, rotation success, collision rollback, old-token rejection, new-token access, and APP-019 route preservation.
