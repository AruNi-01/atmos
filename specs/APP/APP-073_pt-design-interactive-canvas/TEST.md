# TEST · APP-073: PT Design Interactive Canvas

> Test Plan · extract/project, real DOM Interact, Excalidraw Edit + **native undo**, Agent PTX. References PRD APP-073 and TECH APP-073. No APP-062 compatibility tests.
...
| S6 | E2E | Playwright `just test-e2e -- tests/specs/APP-073_pt-design-interactive-canvas.e2e.ts` | Interact | select+input+click | values in extract; action fired | planned |
