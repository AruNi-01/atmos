# TECH · APP-073: PT Design Interactive Canvas

> Technical Design · HOW. Implements PRD APP-073. Addresses **M1–M16** including **full existing catalog** (M4). **N3–N7** deferred. N1/N2 (extra types / blocks) are **not** deferred — they are M4.
>
