...
- **Relation to APP-014**: This spec **adds an external relay** for the same default board and tldraw document. It does **not** replace manual canvas use or change the core “terminal card + built-in shapes” product.
