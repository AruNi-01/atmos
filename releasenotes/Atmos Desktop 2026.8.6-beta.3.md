> **Beta release.** Beta.3 supersedes beta.2. It carries all beta.2 content plus the packaging fix below. Please report issues before the next stable cut.

## Changes Since Beta.2

- Fixed Windows desktop packaging: web static export now uses webpack instead of Turbopack, avoiding a Next 16.3 prerender crash (`Element type is invalid … got: null`) that blocked the Windows build while macOS/Linux succeeded.

---

> **Beta release.** Beta.2 supersedes beta.1. It carries all beta.1 content plus the packaging fix below. Please report issues before the next stable cut.

## Changes Since Beta.1

- Fixed desktop web static typecheck after the Next.js 16.3 bump: Appshots history test mock now implements `IntersectionObserver.scrollMargin`, unblocking multi-platform packaging.
...
- Release tag: `desktop-electron-2026.8.6-beta.3`
- Full comparison: https://github.com/AruNi-01/atmos/compare/desktop-electron-2026.8.2-beta.1...desktop-electron-2026.8.6-beta.3
...
- [Apple Silicon](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.8.6-beta.3/Atmos_2026.8.6-beta.3_aarch64.dmg) (recommended)
- [Intel](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.8.6-beta.3/Atmos_2026.8.6-beta.3_x64.dmg)

### Windows

- [64-bit installer](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.8.6-beta.3/Atmos_2026.8.6-beta.3_x64-setup.exe)

### Linux

- [64-bit AppImage](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.8.6-beta.3/Atmos_2026.8.6-beta.3_x64.AppImage)
