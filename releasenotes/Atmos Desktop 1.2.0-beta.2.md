> **Beta release.** This is the second beta for Atmos Desktop 1.2.0, building on the complete 1.1.0 feature set with new Atmos Computer remote access capabilities. This release is ready for external testing — please report any issues you encounter.
