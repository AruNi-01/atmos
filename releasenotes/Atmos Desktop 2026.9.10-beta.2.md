...
- **Archive undo** — archiving a workspace shows a 5-second undo pill in the bottom-left so you can restore it before the archive commits.
- **Hub sign-in** — sign in with GitHub or Google from the header, welcome gate, and computer settings instead of pasting an access key.
- **Factory Droid** — Mode and permission stay separate in the composer, Fast is remembered per model, the picker groups models, and quota shows Droid Core windows.
- **Agent Chat** — thinking and plan stay in the assistant process fold; Skills tabs no longer steal the center pane; copy an image from preview context menus.
- **Desktop** — stop AppKit scans from crashing host-shortcuts.
...
- Release tag: `desktop-electron-2026.9.10-beta.2`
- Full comparison: https://github.com/AruNi-01/atmos/compare/desktop-electron-2026.9.10-beta.1...desktop-electron-2026.9.10-beta.2
...
- [Apple Silicon](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.9.10-beta.2/Atmos_2026.9.10-beta.2_aarch64.dmg) (recommended)
- [Intel](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.9.10-beta.2/Atmos_2026.9.10-beta.2_x64.dmg)

### Windows

- [64-bit installer](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.9.10-beta.2/Atmos_2026.9.10-beta.2_x64-setup.exe)

### Linux

- [64-bit AppImage](https://github.com/AruNi-01/atmos/releases/download/desktop-electron-2026.9.10-beta.2/Atmos_2026.9.10-beta.2_x64.AppImage)
