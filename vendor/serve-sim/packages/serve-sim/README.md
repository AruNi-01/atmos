...
Run `npx @expo/serve-sim` alongside your Expo dev server. The preview is at
`http://localhost:3200` by default. No `metro.config.js` change is required to
stream a booted iOS Simulator.
