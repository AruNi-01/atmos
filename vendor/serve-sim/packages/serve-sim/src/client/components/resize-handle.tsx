...
export function ResizeHandle({
  ...
  // Both panels sit 12px off the viewport edge as floating cards. A right
  // panel's draggable (left) border is at right:(12 + panelWidth - 1); a left
  // panel's draggable (right) border is at left:(12 + panelWidth - 1). Center
  // the 16px hit target on whichever border is interior.
