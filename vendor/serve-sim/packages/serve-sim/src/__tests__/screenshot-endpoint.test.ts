...
// Consumed by host dashboard save-screenshot actions (the serve-sim web UI
// shells out over exec-ws instead). Restored after the fetch-style middleware
// rewrite (bff5212) dropped the route.
