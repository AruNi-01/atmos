...
describe("startHostPathDrop", () => {
  test("dismisses the screenshot toast when a host screenshot path is dropped", async () => {
    ...
    const done = startHostPathDrop({
      hostPath: "/Users/me/Desktop/simulator-screenshot.png",
      exec,
      udid: "UDID",
    ...
    expect(events[0]).toBe("dismiss:/Users/me/Desktop/simulator-screenshot.png");
    expect(events[1]).toBe("start:simulator-screenshot.png:media");
    await done;
