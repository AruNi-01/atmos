...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/project-wiki-window/{workspace_id}", get(handlers::check_project_wiki_window))
        .route("/project-wiki-window/{workspace_id}", post(handlers::kill_project_wiki_window))
