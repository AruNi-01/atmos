...
use core_service::{
    AgentHooksService, AgentService, MessagePushService, NotificationService, ProjectAstService,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let project_ast_service = Arc::new(ProjectAstService::new(Arc::clone(&db)));
