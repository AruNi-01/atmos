...
Run configurations can include model, reasoning or thinking level, and extra arguments. Atmos blocks conflicting flags when a structured model or reasoning setting is active.
