...
describe("tok path matching", () => {
  ...
  it("proxies Next, brand-icon, and favicon paths as app assets", () => {
    ...
    expect(isProxiedAppAssetPath("/icon.png")).toBe(true);
...
describe("handleLandingRequest", () => {
  it("proxies /tok HTML, keeps same-origin /_next URLs, and does not 302", async () => {
