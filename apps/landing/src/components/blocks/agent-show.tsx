...
export const AgentShow = () => {
  ...
  return (
    <MotionPreset
      ...
      delay={0.15}
      className='relative w-full min-w-0 overflow-hidden border-y'
    >
      <LandingFrame
        side={<BlinkingGrid className={landingRailClassName} />}
        contentClassName='bg-background'
      >
        <div className='flex w-full min-w-0 flex-col gap-2.5 px-4 py-3 sm:px-6 sm:py-2.5 md:flex-row md:items-center lg:px-8'>
          <MotionPreset
            fade
            slide
            blur
