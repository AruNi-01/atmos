...
import { grokGoalPhaseSections } from "@/features/agent/lib/grok-chrome";
...
export function GrokGoalPanel({
  ...
  const sections = grokGoalPhaseSections(goal, messages);
    ...
    >
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger asChild>
          ...
          >
            <ComposerCollapseGlyph icon={Flag} collapsed={!isOpen} />
