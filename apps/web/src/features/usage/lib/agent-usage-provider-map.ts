...
export const AGENT_TO_USAGE_PROVIDER_IDS: Readonly<Record<string, readonly string[]>> = {
  ...
  kimi: ["kimi"],
  amp: ["amp"],
  // commandcode usage provider is currently disabled in ai-usage
};
