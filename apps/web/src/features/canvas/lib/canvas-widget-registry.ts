...
export const CANVAS_WIDGET_REGISTRY: Record<CanvasWidgetType, CanvasWidgetRegistryEntry> = {
  ...
  "pull-requests": {
    type: "pull-requests",
    group: "code-review",
    label: canvasWidgetRegistryT("items.pullRequests.label"),
    description: canvasWidgetRegistryT("items.pullRequests.description"),
    icon: GitPullRequestCreate,
    defaultSize: CANVAS_WIDGET_DEFAULT_SIZES["pull-requests"],
    addable: true,
    requiresContext: true,
  },
  actions: {
    type: "actions",
    group: "code-review",
    label: canvasWidgetRegistryT("items.actions.label"),
    description: canvasWidgetRegistryT("items.actions.description"),
    icon: Workflow,
    defaultSize: CANVAS_WIDGET_DEFAULT_SIZES.actions,
    addable: true,
    requiresContext: true,
  },
  center: {
