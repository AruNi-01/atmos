...
/**
 * sessionId / dynamicTitle / oscTitle stay frontend-only (titles use localStorage).
 * Older layouts may still include `oscTitle`; hydrate reads it once as a fallback.
 */
