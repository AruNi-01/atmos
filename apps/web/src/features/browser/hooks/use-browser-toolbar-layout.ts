...
export function useBrowserToolbarLayout({
  ...
  const shouldHideToolbarUtilityActions =
    resolvedTransportMode === "desktop" ? false : toolbarWidth > 0 && toolbarWidth < 540;
