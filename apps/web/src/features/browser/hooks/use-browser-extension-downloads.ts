...
import { readExtVersionCheckTs, writeExtVersionCheckTs } from "@/shared/stores/use-ui-pref-hooks";
...
interface UsePreviewExtensionDownloadsArgs {
  ...
  transportMode: BrowserTransportMode | "unavailable";
}
...
export function useBrowserExtensionDownloads({
  extensionVersionRef,
