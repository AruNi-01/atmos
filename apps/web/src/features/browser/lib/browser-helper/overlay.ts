...
function createOverlayBox(doc: Document, color: string): HTMLDivElement {
  ...
  node.setAttribute('data-atmos-browser-overlay', 'true');
...
export function createPreviewOverlay(doc: Document): OverlayController {
  ...
  cursorStyle.setAttribute('data-atmos-browser-overlay', 'true');
  ...
  function setCursor(cursor: string) {
    ...
    cursorStyle.textContent = `
      ...
      [data-atmos-browser-overlay="true"],
      [data-atmos-browser-overlay="true"] * {
        cursor: default !important;
      }
      [data-atmos-browser-overlay="true"] button,
      [data-atmos-browser-overlay="true"] button * {
        cursor: pointer !important;
      }
      [data-atmos-browser-overlay="true"] input,
      [data-atmos-browser-overlay="true"] textarea,
      [data-atmos-browser-overlay="true"] [contenteditable="true"] {
