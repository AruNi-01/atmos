...
import type { LeftSidebarTab } from "@/lib/nuqs/searchParams";
import type { Project, WorkspaceLabel } from "@/types/types";
...
import type { SidebarGroupingMode } from "@/components/layout/sidebar/workspace-status";
