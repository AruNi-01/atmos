...
import type { TerminalFileLinkOpenMode } from '@/hooks/use-terminal-link-settings';
import type { NotificationSettings, PushServerConfig } from '@/hooks/use-notification-settings';
import type { QuickOpenAppName } from '@/components/layout/quick-open-apps';
...
import { CanvasSettingsSection } from '@/components/dialogs/CanvasSettingsSection';
import { CodeAgentSettingsSection } from '@/components/dialogs/CodeAgentSettingsSection';
import { EditorSettingsSection } from '@/components/dialogs/EditorSettingsSection';
import { ExperimentSettingsSection } from '@/components/dialogs/ExperimentSettingsSection';
import { IntegrationsSettingsSection } from '@/components/dialogs/IntegrationsSettingsSection';
import { LabelSettingsSection } from '@/components/dialogs/LabelSettingsSection';
import { LayoutSettingsSection } from '@/components/dialogs/LayoutSettingsSection';
import { NotifySettingsSection } from '@/components/dialogs/NotifySettingsSection';
import { ShortcutsSettingsSection } from '@/components/dialogs/ShortcutsSettingsSection';
import { TerminalSettingsSection } from '@/components/dialogs/TerminalSettingsSection';
import { WorkspaceSettingsSection } from '@/components/dialogs/WorkspaceSettingsSection';
import { SettingsAboutSection } from '@/components/dialogs/SettingsAboutSection';
import { SettingsAiSection, type ProviderTestState } from '@/components/dialogs/SettingsAiSection';
import type { SettingsSectionId } from '@/components/dialogs/settings-modal-sidebar';
