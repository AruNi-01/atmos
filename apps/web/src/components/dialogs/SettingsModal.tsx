...
function IntegrationsSettingsSection() {
  const [ghCliStatus, setGhCliStatus] = React.useState<{ installed: boolean; authenticated: boolean; version: string | null; username: string | null } | null>(null);
  const [tmuxStatus, setTmuxStatus] = React.useState<{ installed: boolean; version: string | null } | null>(null);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="overflow-hidden rounded-2xl border border-border">
        <div className="grid grid-cols-[minmax(0,1fr)_320px] gap-8 px-6 py-5">
          <div className="flex items-start gap-3">
            <Github className="size-5 shrink-0 mt-0.5" />
            <div>
      ...
      <div className="overflow-hidden rounded-2xl border border-border">
        <div className="grid grid-cols-[minmax(0,1fr)_320px] gap-8 px-6 py-5">
          <div className="flex items-start gap-3">
            <TmuxIcon className="size-5 shrink-0 mt-0.5" />
            <div>
