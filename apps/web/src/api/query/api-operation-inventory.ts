...
export const apiOperationInventory = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    legacyOwner: "TmuxCheckProvider component local state",
  ...
  },
  {
    ...
    transport: "rest",
    classification: "query",
    legacyOwner: "system-query-options / TmuxCheckProvider",
  ...
  {
    domain: "usage",
    operation: "usageOverviewGet",
    transport: "websocket-request",
    classification: "query",
    legacyOwner: "Footer / UsagePopover component local state",
    queryKeyRoot: "queryKeys.computer.usageOverview",
    phase: "pilot",
    status: "complete",
  },
  {
    domain: "usage",
    operation: "usageOverviewUpdated",
    transport: "websocket-event",
    classification: "event",
    legacyOwner: "UsagePopover.tsx / Footer.tsx onEvent subscriptions",
    queryKeyRoot: "queryKeys.computer.usageOverview",
    invalidatedBy: ["usage_overview_updated"],
    phase: "pilot",
    status: "complete",
  },
  ...
  },
  {
    ...
    legacyOwner: "ChangesCodeView / DiffViewer direct gitApi calls",
    rationale: "Content rendering uses imperative batched loading; caching per-file diffs is a separate optimization",
    phase: "deferred",
    status: "deferred",
  },
  {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    transport: "websocket-request",
    classification: "query",
    legacyOwner: "TokenUsageDialog local useState",
  ...
  },
  {
    ...
    transport: "websocket-event",
    classification: "event",
    legacyOwner: "TokenUsageDialog onEvent subscription",
    queryKeyRoot: "queryKeys.computer.tokenUsageOverview",
  ...
  },
  {
    ...
    transport: "websocket-request",
    classification: "query",
    legacyOwner: "use-automation-run-history-state hook useState",
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    transport: "websocket-request",
    classification: "deferred",
    legacyOwner: "use-canvas-board mixed REST/WS callers",
    phase: "deferred",
    status: "deferred",
    rationale: "Transport choice (REST vs WS write ownership) is unresolved. Canvas waits for transport consolidation.",
  },
  {
    domain: "canvas",
    ...
    transport: "websocket-request",
    classification: "deferred",
    legacyOwner: "use-canvas-board mutation",
    phase: "deferred",
    status: "deferred",
    rationale: "Blocked by same transport decision as canvasBoardLoad.",
  },
  {
    domain: "canvas",
