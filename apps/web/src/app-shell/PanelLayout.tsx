...
const ROOT_RESIZE_SEAM = resizeFollowSeamAt(CENTER_STAGE_GUTTER_X_PX);
...
function ResizeHandle({
  ...
  return (
    <PanelResizeHandle
      ...
      className={cn(
        "relative z-20 w-3 -mx-1.5 overflow-visible bg-transparent touch-none",
        className
      )}
    >
      {hideMark ? null : (
