...
export type SettingsModalTab = "about" | "terminal" | "code-agent" | "workspace" | "labels" | "integrations" | "ai" | "notify" | "remote-access" | "layout" | "shortcuts";

export const settingsModalParams = {
  settingsModal: parseAsBoolean.withDefault(false),
  activeSettingTab: parseAsStringEnum<SettingsModalTab>(["about", "terminal", "code-agent", "workspace", "labels", "integrations", "ai", "notify", "remote-access", "layout", "shortcuts"]).withDefault("layout"),
};
