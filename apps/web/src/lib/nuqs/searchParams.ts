...
export type SettingsModalTab = "about" | "terminal" | "code-agent" | "ai" | "notify";

export const settingsModalParams = {
  settingsModal: parseAsBoolean.withDefault(false),
  activeSettingTab: parseAsStringEnum<SettingsModalTab>(["about", "terminal", "code-agent", "ai", "notify"]).withDefault("about"),
};
