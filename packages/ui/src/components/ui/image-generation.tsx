...
/**
 * Image Generation — beUI agent canvas (queued → generating → complete).
 * Vendored from https://beui.dev/components/agents/image-generation
 * Author: Saurabh / beUI (copy-paste free component).
 * Adapted for @workspace/ui import paths; keep ImageGenerationCanvas (AIcss) below.
 */
...
import { EASE_IN_OUT, EASE_OUT, SPRING_PRESS } from "@workspace/ui/lib/ease";
