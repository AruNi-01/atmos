...
void main(){
  ...
  if (uCenterFade > 0.0) {
    ...
    float cFade = smoothstep(0.0, uCenterRadius, dist);
    M *= mix(1.0, cFade, uCenterFade);
  }
...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      t.uniforms.uCenterRadius.value = centerRadius;
  ...
  return (
    <div
      ref={containerRef}
      className={`size-full relative overflow-hidden ${className ?? ""}`}
      style={style}
