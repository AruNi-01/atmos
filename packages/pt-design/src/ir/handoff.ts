...
export const LIVE_BOARD_INSTRUCTIONS =
  "The live board is the open Prototype Design tab, not a .ptdesign.json file. POST the invoke URL with client_id. Do not start MCP, do not join a collaboration room, and do not write a separate file.";
