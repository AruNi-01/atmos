...
describe("excalidraw Atmos chrome", () => {
  test("board disables invert and remaps islands to Atmos tokens", () => {
    ...
    expect(css).toContain("--pt-back-slot: calc(var(--pt-island-size) + 8px)");
    ...
    expect(css).toContain("left: calc(var(--editor-container-padding, 1rem) + var(--pt-back-slot, 0px) + var(--pt-island-size) + 8px)");
