...
impl WsMessageService {
    ...
    async fn send_workspace_gitignore_sync_failed(
        ...
        let message = WsMessage::notification(WsEvent::WorkspaceGitignoreSyncFailed, json!(payload));
        let _ = manager.broadcast(&message).await;
    }
    ...
    fn queue_workspace_gitignore_compensation(
        &self,
        workspace_id: String,
        project_guid: String,
            ...
            let project = match project_service.get_project(project_guid.clone()).await {
                ...
                Ok(None) => {
                    ...
                    Self::send_workspace_gitignore_sync_failed(
                        ...
                        WorkspaceGitignoreSyncFailedNotification {
                            workspace_id,
                            message: "Could not load project settings for GitIgnore sync.".to_string(),
                        },
                    )
                    .await;
                    return;
