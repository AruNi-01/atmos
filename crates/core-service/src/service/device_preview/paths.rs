...
impl DevicePreviewPaths {
    ...
    /// Directory for ephemeral screenshots: `tmp/device-preview/<workspace_id>/`.
    pub fn device_preview_tmp(&self, workspace_id: &str) -> PathBuf {
        self.tmp_dir.join(workspace_id)
    }
}
