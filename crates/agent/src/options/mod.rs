...
pub use probe::{
    ...
    collapse_cursor_cli_models, collapse_droid_fast_models, config_options_from_session_payload,
    ...
    map_to_advertised_cursor_model, model_id_is_table_noise, models_look_like_cursor_acp,
    overlay_droid_model_catalog, parse_droid_help, parse_line_list,
