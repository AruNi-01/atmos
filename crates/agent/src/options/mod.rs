...
pub use probe::{
    ...
    parse_droid_help, parse_line_list, probe_result_from_config_options,
    snapshot_message_needs_auth, thinking_from_builtin, AcpLaunchResolved, AcpLaunchResolver,
    ...
    OptionsProbe, ProbePlan, ProcessCommandRunner, StdioAcpOptionsProbe, CLI_LOGIN_METHOD_PREFIX,
