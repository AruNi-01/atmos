...
pub use probe::{
    ...
    collapse_droid_fast_models, config_options_from_session_payload, cursor_model_base,
    ...
    grok_thinking_for_model_id, is_cli_login_method_id, is_native_chat_options_id,
