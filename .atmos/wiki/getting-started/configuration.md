...
| File | Purpose |
|------|---------|
| `/Users/lurunrun/own_space/OpenSource/atmos/justfile` | Build and development commands |
| `/Users/lurunrun/own_space/OpenSource/atmos/Cargo.toml` | Rust workspace configuration |
| `/Users/lurunrun/own_space/OpenSource/atmos/package.json` | JavaScript workspace config |
| `/Users/lurunrun/own_space/OpenSource/atmos/apps/api/src/config` | API server configuration |
| `/Users/lurunrun/own_space/OpenSource/atmos/crates/infra/src/db` | Database configuration |
| `/Users/lurunrun/own_space/OpenSource/atmos/apps/web/next.config.ts` | Next.js configuration |
